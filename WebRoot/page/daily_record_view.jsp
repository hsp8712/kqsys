...
<html>
  ...
  <body>
  	<H:table name="page" tableClass="tableClass" var="dailyRecord" formName="inputForm" showPageBottom="true">
		...
		<H:tablefield title="首次打卡时间" ><fmt:formatDate value="${dailyRecord.firstTime }"  pattern="HH:mm:ss" /></H:tablefield>
		<H:tablefield title="最后打卡时间" ><fmt:formatDate value="${dailyRecord.lastTime }"  pattern="HH:mm:ss" /></H:tablefield>
		<H:tablefield title="加班开始时间" ><fmt:formatDate value="${dailyRecord.overTime }"  pattern="HH:mm:ss" /></H:tablefield>
